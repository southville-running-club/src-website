...
> this application. See [P7](../principles.md#p7--race-day-is-safety-critical-the-website-is-not).
...
[P6](../principles.md#p6--boring-by-default) already being practised.
...
This is [P8](../principles.md#p8--personal-data-is-a-liability-not-an-asset) already
...
[R1](../risks.md#r1--key-person-dependency), and it should happen before the port, not
after.
