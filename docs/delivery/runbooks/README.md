...
| [**Opening entries**](entries-open.md) **④** | **The moment the club starts taking money.** One `update` with no pull request to review it, so everything that must be true first is step 0 | [Phase 3](../phases.md#phase-3--nightingale-nightmare-live) |
