...
| [Architecture](docs/architecture/) | **How it is built** — [repositories](docs/architecture/repositories.md), [networking](docs/architecture/networking.md), [database](docs/architecture/database.md), [deployment](docs/architecture/deployment.md), [local development](docs/architecture/local-development.md) |
